...
public class BoscoBot
{
    ...
    else if(findKeyword(statement, "Alumni"))
    {
      response = "The Alumni are always welcome back at Bosco Tech. They can become involved in the Alumni Association or in giving donatons.";
    }
    else if(findKeyword(statement, "donate"))
    {
      response = "Donations are always welcome at Bosco Tech, wether we are giving them or reciving them. The campus donates any money made from recyclables and uses the donated money in any way that the Alumni requests, as long as it helps the campus and does not harm the future of the school.";
    }
    else if(findKeyword(statement, "transcript"))
    {
      response = "The Alumni can always visit the Alumni tab of the Don Bosco Technical Institute and fill out a form for an official transcript.";
    }
